...
if [ -z "$PYTHON_BIN" ]; then
  echo "Python 3.12 or newer is required. Install it with Homebrew: brew install python@3.12" >&2
  exit 1
fi
...
"$PROJECT_DIR/.venv/bin/python" -m pip install -e "$PROJECT_DIR" >/dev/null
